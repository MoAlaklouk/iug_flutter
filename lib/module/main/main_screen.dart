...
import 'package:iug_app/module/addExercies/addexercise_screen.dart';
...
import 'package:iug_app/widget/custom_dialog.dart';
    ...
    return SafeArea(
      child: ChangeNotifierProvider(
        ...
        builder: (context, child) {
          ...
          return Scaffold(
              floatingActionButton: flot(context, controller),
              body: Stack(
                children: [
                  Container(
                            ...
                            IconButton(
                                onPressed: () async {
                                  DialogHelper.showDialogs(
                                      context: context,
                                      title: 'Exit App',
                                      description: 'are you sure exit app',
                                      confirm: () async {
...
flot(context, MainController controller) => FloatingActionButton(
      backgroundColor: Colors.black,
      child: Icon(Icons.add),
      onPressed: () {
        Helper.naviagtTo(context, AddExercisesScreen());
      },
    );
